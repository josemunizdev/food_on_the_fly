...
def main(cfg: DictConfig) -> None:
    ...
    with mlflow.start_run(run_name=cfg.mlflow.run_name):
        ...
        drop_cols = [target_col, "ID", "Delivery_person_ID",]  # Drop target and ID columns

        X_train = train_df.drop(columns=drop_cols)
        y_train = train_df[target_col]
        logger.info("Features and target separated. X shape: %s, y shape: %s", X_train.shape, y_train.shape)
