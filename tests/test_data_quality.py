...
class TestNoNegativeDeliveryTimes:
    ...
    def test_within_reasonable_range(self, df):
        col = "Time_taken (min)"
...
class TestLatLonBoundsMatchCityCoordinates:
    ...
    def test_restaurant_latitude_in_bounds(self, df):
    ...
    def test_coordinates_globally_valid(self, df):
        checks = {
    ...
    def test_city_column_values(self, df):
